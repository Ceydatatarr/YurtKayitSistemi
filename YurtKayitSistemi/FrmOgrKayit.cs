    ...
    public partial class FrmOgrKayit : Form
    {
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            try 
            {
                ...
                SqlCommand komutkaydet2=new SqlCommand("insert into Debts (StudentName,StudentSurname) values(@b1,@b2) ", bgl.baglanti());
                komutkaydet2.Parameters.AddWithValue("b1", TxtOgrAd.Text);
                komutkaydet2.Parameters.AddWithValue("b2", TxtOgrSoyad.Text);
...
//Data Source = DESKTOP - C\SQLEXPRESS; Initial Catalog = YurtKayit; Integrated Security = True; Encrypt = False
